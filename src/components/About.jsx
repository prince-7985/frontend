      ...
      <section className="about" id="about">
        <div className="container">
          <div className="banner">
            ...
            <p className="mid">
              Welcome to [Prince Restaurant], where we believe that dining is more than just a meal—it's an experience. Whether you're planning an intimate dinner, a special celebration, or a casual outing with friends, our restaurant offers the perfect ambiance, exceptional cuisine, and warm hospitality to make your visit memorable.
              ...
              Book your table with us today and discover why [Prince Restaurant] is a favorite among food lovers. We look forward to serving you!
            </p>
            <Link to={"/"}>
              Explore Menu{" "}
              <span>
